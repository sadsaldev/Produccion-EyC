                ...
                <div className="networks-form-container-grid">
                    <div className="networks-table-options">
                        <div className="options-left">
                            <img id="add-row" src="/assets/img/add.svg" alt="add-row" title="Añadir fila" onClick={() => append({ contrato: '', solicitud: '' })}/>
                            <img id="delete-row" src="/assets/img/minus.svg" alt="delete-row" title="Eliminar fila"  onClick={() => fields.length > 1 && remove(fields.length - 1)}/>
                        </div>
                        <div className="options-right">
                            <img id="clear-rows-content" src="/assets/img/reload.svg" alt="clear-table" title="Limpiar registros" onClick={clearRowsContent} />
                        </div>
                    </div>
                                    ...
                                    {user ? (
                                        <>
                                            <button type="submit" className="export-excel-networks" onClick={handleSubmit(data => onSubmitHandler(data, true))}>
                                                <img src="/assets/img/excel-white.svg" alt="Descargar Excel" />Descargar Excel
                                            </button>
                                            <button type="button" className="view-networks-content" onClick={handleSubmit(data => onSubmitHandler(data, false))}>
                                                Ver Contenido<img src="/assets/img/show-content-white.svg" alt="Ver Contenido" />
                                            </button>
                                        </>
                                    ) : (
                                        <>
