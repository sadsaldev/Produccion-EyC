                        ...
                        <div className="pop-ups-container">
                            <div className="admin-panel-container">
                                <div className='admin-setings-container'>
                                    <div className='close-profile-edit'><img className='close-profile-edit-img' id="close-admin-panel" src='/assets/img/close.svg' alt='close-icon' onClick={goBackToMenu}/></div>
                                                        ...
                                                        <tr key={user.cedula} className="user_row" data-user-id={user.cedula}>
                                                            ...
                                                            {user.role !== 'super_user' && (
                                                                ...
                                                                <button className="toggleUserStatus" data-user-id={user.cedula} onClick={() => changeStatus(user.cedula)}>
                                                                    <img 
                                                                        src={user.status === 'enabled' ? '/assets/img/user-disable.svg' : '/assets/img/user-enable.svg'} 
                                                                        alt={user.status === 'enabled' ? 'disable-user' : 'enable-user'} 
                                                                        title={user.status === 'enabled' ? 'Desactivar usuario' : 'Activar usuario'}
                                                                    />
                                                                </button>
                                                                <button className="deleteUser" data-user-id={user.cedula} onClick={() => removeUser(user.cedula)}><img src="/assets/img/trash-can.svg" alt="delete-user" title="Eliminar usuario"/></button>
                                                                </>
                                                            )}
                                                            </td>
                                                        </tr>
