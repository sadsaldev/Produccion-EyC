                    ...
                    <div id="profile-content">
                        <div className='pop-ups-container'>
                            <div className='edit-user-info-container'>
                                <div className='close-profile-edit'><img className='close-profile-edit-img' id='close-profile-settings' src='/assets/img/close.svg' alt='close-icon' onClick={goBackToMenu}/></div>
