                ...
                <div className="queries-form-container-grid">
                    ...
                    <div className="queries-options">
                        <div className="view-content">
                            ...
                            >
                                <img className="viewmain-img" src="/produccion-EyC-deploy/public/assets/img/viewmain.svg"/>
                                    Ver Tabla General
                            </button>
                            <button 
                            ...
                            >
                                <img className="viewgrouped-img" src="/produccion-EyC-deploy/public/assets/img/viewgrouped.svg"/>
                                    Ver Por Inspector
                            </button>
                        </div>
                        <div className="download-excel">
                            ...
                            >
                                <img className="exportexcel-img" src="/produccion-EyC-deploy/public/assets/img/excel-white.svg"/> 
                                    Exportar
                            </button>
                        </div>
                    </div>    
