                                        ...
                                        { user ? (
                                            <div className="queries-options-menu">
                                                <div className="search-inspec-father" onClick={handleSearchEfective}>
                                                    <img className="search-inspections-img" src="/produccion-EyC-deploy/public/assets/img/search-inspections.svg" />
                                                    <p id='search-inspections'>Consultar Efectivas</p>
                                                </div>
                                                <div className="new-networks-father" onClick={handleNetworks}>
                                                    <img className="generate-rn-img" src="/produccion-EyC-deploy/public/assets/img/new-networks.svg" />
                                                ...
                                                <div className="placeholder-popup-img"><img src="/produccion-EyC-deploy/public/assets/img/info-icon-blue.png" alt="Info Icon"/></div>
                                                </>
                                            )}
                                    </div>
                                </div>
