        ...
        <>
            <header>
                <nav className="navbar">
                    <div className="logo">
                        <img className="logo-img" src="/produccion-EyC-deploy/public/assets/img/logo-white.png" alt="logo E&C" title="E&C Ingeniería" onClick={handleIndex} />
                        {activeRoute !== '/index' && (
                    ...
                    <div className="flex-end-navbar-items">
                        ...
                        {!isFloatingMenu && (
                            <ul className="menu-flex" id="navbar-menu-flex">
                                <li><NavLink className={`navelement ${activeRoute === '/index' ? 'active' : ''}`} to="/index">Inicio</NavLink></li>
                        ...
                        <div className="aside-menu">
                            ...
                            <div className="navbar-menu">
                                <ul className="menu" id="navbar-menu">
                                    <li><NavLink className={`navelement ${activeRoute === '/index' ? 'active' : ''}`} to="/index" onClick={() => setIsFloatingMenu(!isFloatingMenu)}>Inicio</NavLink></li>
